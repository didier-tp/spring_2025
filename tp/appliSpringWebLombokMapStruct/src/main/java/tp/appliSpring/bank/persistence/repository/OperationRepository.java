...
public interface OperationRepository extends JpaRepository<OperationEntity,Long> {
    ...
    @Query("SELECT op FROM OperationEntity op WHERE op.compte.numero=:numCompte AND op.dateOp between :dateMin and :dateMax ")
    List<OperationEntity> findForCompteWithDateBetween(@Param("numCompte") Long numCompte,
